...
export default function Aes() {
  ...
  return (
    <TwoPaneLayout
      ...
      left={
        <div className="flex h-full flex-col gap-3">
          <div className="flex flex-1 flex-col">
            <span className="mb-1 text-xs text-muted-foreground">Text</span>
            <CodeEditor value={input} onChange={setInput} placeholder="Text or ciphertext…" />
          </div>
          <div className="flex flex-1 flex-col">
      ...
      right={<CodeEditor value={output} readOnly placeholder="Result…" />}
